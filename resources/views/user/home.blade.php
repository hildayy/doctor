...
<body>
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url(bg.jpg);">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        <span class="subhead">Let's make your life happier</span>
        <h1 class="display-4">Healthy Living</h1>
        <a href="#myappointment" class="btn btn-primary">Make an Appointment</a>
      </div>
    </div>
  </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
              ...
              <p><span>Make appointments</span> with a doctors</p>
            </div>
          </div>
          ...
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
              ...
              <p><span>Follow up</span>-On your health</p>
            </div>
          </div>
          ...
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
              ...
              <p><span>Secured</span>-Medical History</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3 wow fadeInUp">
            <h1>Welcome to My Doc <br> Health Center</h1>
            <p class="text-grey mb-4">Make an appointment, follow up on your appointments and Medical History at your own convinience!</p>
