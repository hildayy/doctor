            ...
            <div class="content-wrapper">
                ...
                <div class="col-md-12 grid-margin">
                    ...
                    @if(session()->has('message'))
                     ...
                     @endif
                    <div class="card-body">
                    <form action="{{url('ruploadDoc',$data->id)}}" method="POST"  enctype="multipart/form-data" >
                        @csrf
                                               
                        <div class="form-group">
                            <label for="docname">Doctor Name</label>
                            <input  class="form-control" type="text"name="docname" value="{{$data->name}}"style="background-color: white;color:black">
                        </div>
                        <div class="form-group">
                            <label for="docphone">Phone Number </label>
                            <input class="form-control" type="number"name="docphone" value="{{$data->phone}}" style="background-color: white;color:black"/>
                        </div>
                        <div class="form-group">
                            <label for="docmail">Doctor Email</label>
                           <input type="text" name="docmail" class="form-control" value="{{$data->email}}"style="background-color: white;color:black" />
                        </div>
                        <div class="form-group">
